...
int Display_Inventory(INVENTORY_MODE invMode) {
...
void SelectMeshes(INVENTORY_ITEM* invItem) {
...
int AnimateInventoryItem(INVENTORY_ITEM* invItem) {
...
void DrawInventoryItem(INVENTORY_ITEM* invItem) {
...
DWORD GetDebouncedInput(DWORD input) {
