...
void DrawEnemyHealthBar(int flashIt) {
...
void DrawGameInfo(BOOL pickupState) {
	BOOL flashState;
...
void DrawAirBar(BOOL flashState) {
	int air;
...
void DrawPickups(BOOL pickupState) {
...
void DisplayModeInfo(char* modeString) {
	if (modeString == NULL) {
