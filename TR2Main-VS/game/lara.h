...
#define lara_as_death ((void(__cdecl*)(ITEM_INFO*, COLL_INFO*)) 0x00427E10)
#define lara_as_fastfall ((void(__cdecl*)(ITEM_INFO*, COLL_INFO*)) 0x00427E30)
#define lara_as_hang ((void(__cdecl*)(ITEM_INFO*, COLL_INFO*)) 0x00427E70)
#define lara_as_reach ((void(__cdecl*)(ITEM_INFO*, COLL_INFO*)) 0x00427ED0)
#define lara_as_splat ((void(__cdecl*)(ITEM_INFO*, COLL_INFO*)) 0x00427EF0)
#define lara_as_compress ((void(__cdecl*)(ITEM_INFO*, COLL_INFO*)) 0x00427F00)
#define lara_as_back ((void(__cdecl*)(ITEM_INFO*, COLL_INFO*)) 0x00428010)
#define lara_as_null ((void(__cdecl*)(ITEM_INFO*, COLL_INFO*)) 0x004280A0)
#define lara_as_fastturn ((void(__cdecl*)(ITEM_INFO*, COLL_INFO*)) 0x004280B0)
#define lara_as_stepright ((void(__cdecl*)(ITEM_INFO*, COLL_INFO*)) 0x00428100)
#define lara_as_stepleft ((void(__cdecl*)(ITEM_INFO*, COLL_INFO*)) 0x00428180)
#define lara_as_slide ((void(__cdecl*)(ITEM_INFO*, COLL_INFO*)) 0x00428200)
#define lara_as_backjump ((void(__cdecl*)(ITEM_INFO*, COLL_INFO*)) 0x00428230)
#define lara_as_rightjump ((void(__cdecl*)(ITEM_INFO*, COLL_INFO*)) 0x00428280)
#define lara_as_leftjump ((void(__cdecl*)(ITEM_INFO*, COLL_INFO*)) 0x004282C0)
#define lara_as_upjump ((void(__cdecl*)(ITEM_INFO*, COLL_INFO*)) 0x00428300)
#define lara_as_fallback ((void(__cdecl*)(ITEM_INFO*, COLL_INFO*)) 0x00428320)
#define lara_as_hangleft ((void(__cdecl*)(ITEM_INFO*, COLL_INFO*)) 0x00428350)
#define lara_as_hangright ((void(__cdecl*)(ITEM_INFO*, COLL_INFO*)) 0x00428390)
#define lara_as_slideback ((void(__cdecl*)(ITEM_INFO*, COLL_INFO*)) 0x004283D0)
#define lara_as_pushblock ((void(__cdecl*)(ITEM_INFO*, COLL_INFO*)) 0x004283F0)
#define lara_as_ppready ((void(__cdecl*)(ITEM_INFO*, COLL_INFO*)) 0x00428420)
#define lara_as_pickup ((void(__cdecl*)(ITEM_INFO*, COLL_INFO*)) 0x00428450)
#define lara_as_pickupflare ((void(__cdecl*)(ITEM_INFO*, COLL_INFO*)) 0x00428480)
#define lara_as_switchon ((void(__cdecl*)(ITEM_INFO*, COLL_INFO*)) 0x004284E0)
#define lara_as_usekey ((void(__cdecl*)(ITEM_INFO*, COLL_INFO*)) 0x00428520)
#define lara_as_special ((void(__cdecl*)(ITEM_INFO*, COLL_INFO*)) 0x00428550)
#define lara_as_swandive ((void(__cdecl*)(ITEM_INFO*, COLL_INFO*)) 0x00428570)
#define lara_as_fastdive ((void(__cdecl*)(ITEM_INFO*, COLL_INFO*)) 0x004285A0)
#define lara_as_waterout ((void(__cdecl*)(ITEM_INFO*, COLL_INFO*)) 0x00428600)
#define lara_as_wade ((void(__cdecl*)(ITEM_INFO*, COLL_INFO*)) 0x00428620)
#define lara_as_deathslide ((void(__cdecl*)(ITEM_INFO*, COLL_INFO*)) 0x004286F0)
