...
void phd_TranslateRel_ID(int x, int y, int z, int x2, int y2, int z2); // 0x0041B8A0
void phd_RotYXZ_I(short yRot, short xRot, short zRot); // 0x0041B8F0
void phd_RotYXZsuperpack_I(UINT16** pptr1, UINT16** pptr2, int index); // 0x0041B940
void phd_RotYXZsuperpack(UINT16** pptr, int index); // 0x0041B980
void phd_PutPolygons_I(short* ptrObj, int clip); // 0x0041BA30
void InterpolateMatrix(); // 0x0041BA60
void InterpolateArmMatrix(); // 0x0041BC10
void DrawGunFlash(int weapon, int clip);
void CalculateObjectLighting(ITEM_INFO* item, short* frame); // 0x0041BE80
int GetFrames(ITEM_INFO* item, short** frames, int* rate); // 0x0041BF70
short* GetBoundsAccurate(ITEM_INFO* item); // 0x0041C010
short* GetBestFrame(ITEM_INFO* item); // 0x0041C090
