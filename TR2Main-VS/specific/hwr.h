...
void HWR_ResetTexSource(); // 0x0044D1E0
void HWR_ResetColorKey(); // 0x0044D210
void HWR_ResetZBuffer(); // 0x0044D240
void HWR_TexSource(HWR_TEXHANDLE texSource); // 0x0044D2A0
void HWR_EnableColorKey(bool state); // 0x0044D2D0
