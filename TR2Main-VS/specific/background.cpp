...
void BGND_Make640x480(BYTE *bitmap, RGB888 *palette) {
...
int BGND_AddTexture(int tileIndex, BYTE *bitmap, int palIndex, RGB888 *bmpPal) {
	int pageIndex;
	BYTE *bmpSrc;
	UINT16 *bmpDst;
...
void DrawQuad(float sx, float sy, float width, float height, D3DCOLOR color) {
...
D3DCOLOR BGND_CenterLighting(int x, int y, int width, int height) {
	double xDist, yDist;
	int light;
