...
DWORD Sync(); // 0x00456720
LPVOID UT_LoadResource(LPCTSTR lpName, LPCTSTR lpType); // 0x00456780
void UT_InitAccurateTimer(); // 0x004567C0
double UT_Microseconds(); // 0x00456820
BOOL UT_CenterWindow(HWND hWnd); // 0x00456870
LPTSTR UT_FindArg(LPCTSTR str); // 0x004568E0
int UT_MessageBox(LPCTSTR lpText, HWND hWnd); // 0x00456910
