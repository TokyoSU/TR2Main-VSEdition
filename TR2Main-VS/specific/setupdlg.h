...
int SE_GraphicsTest(); // 0x00452BC0
void SE_DefaultGraphicsSettings(); // 0x00452C20
bool SE_SoundTestStart(); // 0x00452D70
void SE_SoundTestFinish(); // 0x00452E30
int SE_SoundTestExecute(); // 0x00452E40
int SE_SoundTest(); // 0x00452E80
...
HWND SE_FindSetupDialog(); // 0x00454AF0
