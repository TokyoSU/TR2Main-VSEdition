...
int RenderErrorBox(int errorCode) {
	char errorText[128];
...
int WINAPI WinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPSTR lpCmdLine, _In_ int nShowCmd) { // 0x0044E5E0
...
void S_ExitSystem(LPCTSTR message) {
	ShutdownGame();
