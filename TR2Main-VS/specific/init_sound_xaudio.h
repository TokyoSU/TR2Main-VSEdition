...
extern void DSAdjustVolume(DWORD channel, int volume);
...
extern void S_SoundStopSample(DWORD channel);
...
extern void S_SoundSetPanAndVolume(DWORD channel, short pan, int volume);
extern void S_SoundSetPitch(DWORD channel, int pitch);
