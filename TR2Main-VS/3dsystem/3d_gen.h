...
short* __cdecl calc_background_light(short* ptrObj); // 0x00401BD0
void S_InsertBackground(short* ptrObj); // 0x00401C10
void S_InsertInvBgnd(short* ptrObj); // ----------
short* __cdecl calc_object_vertices(short* ptrObj); // 0x00401D50
short* __cdecl calc_vertice_light(short* ptrObj); // 0x00401F30
short* __cdecl calc_roomvert(short* ptrObj, BYTE farClip); // 0x004020A0
