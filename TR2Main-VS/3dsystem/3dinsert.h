...
void InsertTrans8(PHD_VBUF* vbuf, __int16 shade); // 0x00407FF0
...
void InsertClippedPoly_Textured(int vtxCount, float z, __int16 polyType, __int16 texPage); // 0x0040A5D0
...
void InsertPoly_Gouraud(int vtxCount, float z, int red, int green, int blue, __int16 polyType); // 0x0040B1D0
__int16* __cdecl InsertObjectG3_Sorted(__int16* ptrObj, int number, SORTTYPE sortType); // 0x0040B350
#ifdef FEATURE_VIDEOFX_IMPROVED
void InsertSprite_Sorted(int z, int x0, int y0, int x1, int y1, int spriteIdx, __int16 shade, DWORD flags); // 0x0040B6A0
#else // FEATURE_VIDEOFX_IMPROVED
void InsertSprite_Sorted(int z, int x0, int y0, int x1, int y1, int spriteIdx, __int16 shade); // 0x0040B6A0
#endif // FEATURE_VIDEOFX_IMPROVED
...
void InsertTrans8_Sorted(PHD_VBUF* vbuf, __int16 shade); // 0x0040BCA0
void InsertTransQuad_Sorted(int x, int y, int width, int height, int z); // 0x0040BE40
#ifdef FEATURE_VIDEOFX_IMPROVED
void InsertSprite(int z, int x0, int y0, int x1, int y1, int spriteIdx, __int16 shade, DWORD flags); // 0x0040BF80
#else // FEATURE_VIDEOFX_IMPROVED
void InsertSprite(int z, int x0, int y0, int x1, int y1, int spriteIdx, __int16 shade); // 0x0040BF80
#endif // FEATURE_VIDEOFX_IMPROVED
